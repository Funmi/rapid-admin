<template>
  <div>
    ...
    :asideItems="asideItems" :breakPortion="breakPortion" @edit_cancel="editCancel" @edit_confirm="editConfirm"></fm-edit>

    <fm-display :dialogVisible="displayForm.visible" :form="formDataDisplay" 
    @display_cancel="hideDisplayForm" :payload="payload" 
    labelWidth="160px" formWidth="1000px"
    :asideItems="asideItems" :breakPortion="breakPortion"></fm-display>
  </div>
</template>
    ...
    methods: {
      initTable() {
        ...
        this.setTable('columns', [
          ...
          {label: '设施地理位置', prop: 'address', type: 'textarea', hidden: true},
